...
<div id="wrapper" class="wrapper"> 
  ...
  <div class="main-content"> 
    <div align="left" data-ng-controller="BookController as ctrl" data-ng-init="ctrl.fetchAllBooks('<% if(request.getParameter("cat")!=null) out.print(request.getParameter("cat")); %>')">
    <!-- Post Details -->
